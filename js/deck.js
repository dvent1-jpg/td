...
(() => {
  ...
  window.addEventListener('keydown', (e) => {
    if (['ArrowRight', 'ArrowDown', 'Right', 'Down', 'PageDown', ' '].includes(e.key)) { e.preventDefault(); nextSlide(); }
    else if (['ArrowLeft', 'ArrowUp', 'Left', 'Up', 'PageUp'].includes(e.key)) { e.preventDefault(); prevSlide(); }
